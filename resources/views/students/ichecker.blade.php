...
<div id="importPage"
     data-duplicate-report-url="{{ route('ichecker.import') }}">
</div>
<div class="import-page">

    <!-- Page heading -->
    <div class="page-heading">
        <h1>Invcoice Checker</h1>
        <p>Upload the invoice report to check.</p>
    </div>
    ...
    <div class="import-layout">
        ...
        <div class="import-card">
            ...
            <div class="card-body">
                ...
                <form id="importForm" enctype="multipart/form-data" data-import-url="{{ route('ichecker.import') }}">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-upload" id="uploadBtn" disabled>
                        ...
                        <span id="uploadBtnLabel">Upload and Check</span>
                    </button>
